...
- the reference GhostNode SQLite witness detects relay-database rollback only while the witness remains newer; whole-volume/VM rollback that restores the witness too remains outside the protection claim;

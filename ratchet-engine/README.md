...
The engine is now wired to Python through a bounded local stdin/stdout RPC owned by the client process. It is **not yet wired into GhostNode or the user-facing GhostLink CLI message path**.

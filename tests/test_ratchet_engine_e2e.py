...
def test_ratchet_vault_and_reference_witness_coherent_rollback_is_not_detected(
    tmp_path: Path,
) -> None:
    ...
    coordination_key = os.urandom(32)
    state_id = os.urandom(16).hex()
    vault_path = tmp_path / "coherent-rollback.ratchet"
    witness_path = tmp_path / "coherent-rollback-witness.sqlite3"
    witness = SQLiteMonotonicWitness(
        witness_path,
        state_id,
        coordination_key,
